...
namespace NHibernate.Persister.Collection
{
	                                                    ...
	                                                    IPostInsertIdentityPersister
	{
        ...
        public void Initialize(object key, ISessionImplementor session, object owner)
        {
            GetAppropriateInitializer(key, session).Initialize(key, session, OwnerEntityPersister, owner);
        }
