...
namespace GTS.Clock.Presentaion.WebForms
{
    ...
    public partial class Users : GTSBasePage
    {
        ...
        protected void CallBack_GridUsers_Users_OnCallBack(object sender, ComponentArt.Web.UI.CallBackEventArgs e)
        {
            ...
            this.Fill_GridUsers_Users((LoadState)Enum.Parse(typeof(LoadState), this.StringBuilder.CreateString(e.Parameters[0])), int.Parse(this.StringBuilder.CreateString(e.Parameters[1])), int.Parse(this.StringBuilder.CreateString(e.Parameters[2])), (UserSearchKeys)Enum.Parse(typeof(UserSearchKeys), this.StringBuilder.CreateString(e.Parameters[3])), this.StringBuilder.CreateString(e.Parameters[4]));
        ...
        protected void CallBack_cmbPersonnel_Users_onCallBack(object sender, CallBackEventArgs e)
        {
            ...
            this.SetPersonnelPageCount_cmbPersonnel_Users((LoadState)Enum.Parse(typeof(LoadState), this.StringBuilder.CreateString(e.Parameters[0])), int.Parse(this.StringBuilder.CreateString(e.Parameters[1])), this.StringBuilder.CreateString(e.Parameters[3]));
            this.Fill_cmbUsers_Users((LoadState)Enum.Parse(typeof(LoadState), this.StringBuilder.CreateString(e.Parameters[0])), int.Parse(this.StringBuilder.CreateString(e.Parameters[1])), int.Parse(this.StringBuilder.CreateString(e.Parameters[2])), this.StringBuilder.CreateString(e.Parameters[3]));
        ...
        public string[] UpdateUser_UsersPage(string state, string SelectedUserID, string IsActiveUser, string PersonnelID, string RoleID, string UserName, string Password, string ConfirmPassword, string IsActiveDirectoryAuthenticated, string DomainID, string IsPasswordChange)
        {
            ...
            try
            {
                ...
                decimal domainID = decimal.Parse(this.StringBuilder.CreateString(DomainID));
