...
namespace NHibernate.Driver
{
	...
	public class SqlClientDriver : DriverBase, IEmbeddedBatcherFactoryProvider
	{
		...
		{
            return true; // (sqlType is StringClobSqlType) || ((DbType.String == dbParam.DbType || DbType.StringFixedLength == dbParam.DbType) && sqlType.LengthDefined && (sqlType.Length > MaxSizeForLengthLimitedString));
		}
