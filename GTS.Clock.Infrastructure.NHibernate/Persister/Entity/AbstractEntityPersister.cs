                        ...
                        else if (allProperties || !laziness[i])
                        {
                            ...
                            else
                            {
                                ...
                                try
                                {
                                    if (values[i] == null)
                                    {
                                        if (rootPersister.propertyColumnNames.Length > i && rootPersister.PropertyNames[i] != "")
                                        {
                                            object value = rootPersister.GetPropertyValue(obj, propNames[i], EntityMode.Poco);
                                            values[i] = value;
                                        }
                                    }
                                }
                                ...
                                {
                                    throw new Exception(String.Format("{0}: {1}", "AbstractEntityPersister.Hydrate", "خطا در کد نوشته شده توسط صفری نیا", ex));
                                }
                                #endregion
                            }
                        }
