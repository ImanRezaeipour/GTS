<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Users.aspx.cs" Inherits="GTS.Clock.RuleDesigner.UI.Web.Users" %>
...
<head id="Head1" runat="server">
    ...
    <link id="Link10" href="css/tableStyle.css" runat="server" type="text/css" rel="Stylesheet" />
    <link id="Link11" href="css/label.css" runat="server" type="text/css" rel="Stylesheet" />
    <link id="Link12" href="css/dropdowndive.css" runat="server" type="text/css" rel="Stylesheet" />
                    ...
                    <tr>
                        ...
                        <td style="width: 40%" valign="top">
                            <table style="width: 100%; height: 100%;" class="BoxStyle">
                                ...
                                <tr>
                                    <td>
                                        <div id="Div1" runat="server" meta:resourcekey="AlignObj" style="width: 100%" class="DropDownHeader">
                                ...
                                <tr>
                                    <td>
                                        <div id="Div2" runat="server" meta:resourcekey="AlignObj" style="width: 100%" class="DropDownHeader">
                                        ...
                                        <table style="width: 100%;" class="BoxStyle">
                                            <tr>
                                                <td>
                                                    <table style="width: 100%;">
                                                        <tr>
                                                            <td id="Td3" runat="server" meta:resourcekey="AlignObj" style="width: 5%">
                                                                <input id="rdbUserNameIntroduction_Users" disabled="disabled" name="Users" onclick="rdbUserNameIntroduction_Users_onClick();"
                                                                    type="radio" value="V1" />
                                                            </td>
                                                            <td id="Td4" runat="server" meta:resourcekey="AlignObj" style="width: 95%">
                                        ...
                                        <table style="width: 100%;" class="BoxStyle">
                                            <tr>
                                                <td>
                                                    <table style="width: 100%;">
                                                        <tr>
                                                            <td id="Td5" runat="server" meta:resourcekey="AlignObj" style="width: 5%">
                                                                <input id="rdbActiveDirValidation_Users" disabled="disabled" name="Users" onclick="rdbActiveDirValidation_Users_onClick();"
                                                                    type="radio" value="V1" />
                                                            </td>
                                                            <td id="Td6" runat="server" meta:resourcekey="AlignObj" style="width: 95%">
