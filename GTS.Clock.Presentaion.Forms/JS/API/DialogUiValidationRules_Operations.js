...
function CloseDilaogUiValidationRules() {
    parent.document.getElementById('DialogUiValidationRules_IFrame').src = 'WhitePage.aspx';
    parent.DialogUiValidationRules.Close();
}
...
function Fill_GridUiValidationRules_UiValidationRules() {
    document.getElementById('loadingPanel_GridUiValidationRules_UiValidationRules').innerHTML = document.getElementById('hfloadingPanel_GridUiValidationRules_UiValidationRules').value;
    CallBack_GridUiValidationRules_UiValidationRules.callback(CharToKeyCode_UiValidationRules(ObjDialogUiValidationRules.GroupID));
}
...
function Fill_GridParameterUiValidationRules_UiValidationRules(ID, RuleID) {
    ...
    document.getElementById('loadingPanel_GridParameterUiValidationRules_UiValidationRules').innerHTML = document.getElementById('hfloadingPanel_GridParameterUiValidationRules_UiValidationRules').value;
