    ...
    switch (CurrentPageState_Personnel) {
        ...
        case 'Edit':
            ...
            if (selectedPersonnel_Personnel != undefined) {
                ...
                CurrentStateObj_Personnel.Grade = selectedPersonnel_Personnel.getMember('PersonDetail.Grade').get_text();
...
function UpdatePersonnel_Personnel() {
    ...
    UpdatePersonnel_PersonnelPage(CharToKeyCode_Personnel(CurrentPageState_Personnel), CharToKeyCode_Personnel(ObjPersonnel_Personnel.ID), CharToKeyCode_Personnel(ObjPersonnel_Personnel.Image));
    DialogWaiting.Show();
}
